...
import { fetchQuizWithQuestions, resetQuiz, getFinalScore, recordAnswer, getNextQuestion, getPreviousQuestion } from "../redux/quizSlice";
...
export default function QuizPlay() {
    ...
    const { quiz, questions, currentQuestionIndex, loading, scoreFinal, questionRecord } = useAppSelector((state) => state.quiz);
    ...
    const isLastQuestion = currentQuestionIndex !== null && questions && currentQuestionIndex === questions.length - 1;
        ...
        return (
            <Container className="mt-5 text-center">
                <Alert variant="success">
                    ...
                    <hr />
                    <h2>Your Final Score: {scoreFinal} / {questions?.length || 0}</h2>
                    <p className="mb-0">
                        You scored {scoreFinal} out of {questions?.length || 0} questions correctly!
                    </p>
                </Alert>
